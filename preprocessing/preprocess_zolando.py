...
DATA_PATH = '/Users/crescentonc/code/comp5331/datasets_dropbox/clef/raw/'
...
def load_data( file ) : 
    ...
    #load csv
    data = pd.read_csv( file+'.csv', sep=';', header=0, usecols=[0,1,2], dtype={0:np.int64, 1:np.int64, 2:np.int64})
...
#     print(data)
#     quit()
    return data[len(data) // 128 : (len(data) - (100 * (len(data) // 128)))]
