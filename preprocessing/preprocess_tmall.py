...
DATA_PATH = '/Users/crescentonc/code/comp5331/datasets_dropbox/tmall/raw/'
DATA_PATH_PROCESSED = '/Users/crescentonc/code/comp5331/datasets_preprocessed/'
DATA_FILE = 'tmall_trunc'
...
#     print(data)
#     quit()
    # return data[len(data) // 128 : (len(data) - (120 * (len(data) // 128)))]
    return data
