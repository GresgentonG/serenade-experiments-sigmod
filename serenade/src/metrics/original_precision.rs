...
impl OPrecision {
    ...
    ///
    pub fn new(length: usize) -> OPrecision {
        OPrecision {
            sum_of_scores: 0_f64,
            qty: 0,
            length,
...
impl SessionMetric for OPrecision {
...
mod precision_test {
    ...
    fn should_calculate_precision() {
        let length = 20;
        let mut mymetric = OPrecision::new(length);
